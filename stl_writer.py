"""
Discription: Export 3D objects, build of faces with 3 or 4 vertices as ASCII or Binary STL file
History:     original   -- https://gist.github.com/ryansturmer/9329299
             08/25/2021 -- adding comments
"""

#* struct module performs conversions between Python values 
...
def example():
    ...
    # file.write('write_data_to_file')
    # file.close()


#* ----- ----- -----
#* boiler template code for script invoking
#* ----- ----- -----
if __name__ == '__main__':
    #* run example() if this script is invoked directly
    example()
else:
    print("Cowabunga!!!")    
